Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/contentsynciosfoundation.git", :tag => "1.3" }
  s.platform     = :ios, '5.0'
...
#  s.dependency 'OPIFoundation/ZipArchive', :local => @@podLocal + '/OPIFoundation'
  ...
  s.dependency 'OPIFoundation/UtilHelpers', '3.1'
  s.dependency 'OPIFoundation/Reachability', '3.1'
  s.dependency 'OPIFoundation/IOSFrameworkCategories' , '3.1'
  s.dependency 'OPIFoundation/AppUpdater', '3.1'
  s.dependency 'OPIFoundation/ZipArchive', '3.1'
