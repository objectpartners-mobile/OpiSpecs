Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners/contentsynciosfoundation.git", :tag => "3.0" }
  s.platform     = :ios, '6.0'
  ...
  s.dependency 'OPIFoundation/UtilHelpers', '4.0'
  s.dependency 'OPIFoundation/IOSFrameworkCategories' , '4.0'
  s.dependency 'OPIFoundation/AppUpdater', '4.0'
  s.dependency 'OPIFoundation/ZipArchive', '4.0'
