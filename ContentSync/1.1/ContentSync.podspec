Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/contentsynciosfoundation.git", :tag => "1.1" }
  s.platform     = :ios, '5.0'
  ...
  s.dependency 'OPIFoundation/UtilHelpers', '1.4.mod'
  s.dependency 'OPIFoundation/Reachability', '1.4.mod'
  s.dependency 'OPIFoundation/IOSFrameworkCategories' , '1.4.mod'
  s.dependency 'OPIFoundation/AppUpdater', '1.4.mod'
  s.dependency 'OPIFoundation/ZipArchive', '1.4.mod'
