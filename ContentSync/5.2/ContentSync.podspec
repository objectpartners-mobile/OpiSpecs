Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/contentsynciosfoundation.git", :tag => "5.2" }
  s.platform     = :ios, '6.0'
  ...
  s.dependency 'OPIFoundation/UtilHelpers', '~> 5.3'
  s.dependency 'OPIFoundation/IOSFrameworkCategories' , '~> 5.3'
  s.dependency 'OPIFoundation/AppUpdater', '~> 5.3'
  s.dependency 'OPIFoundation/ZipArchive', '~> 5.3'
