Pod::Spec.new do |s|
  ...
  s.dependency 'OPIFoundation/IOSFrameworkCategories', '3.3'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '3.3'
  s.dependency 'OPIFoundation/UILayoutManagers', '3.3'
  s.dependency 'OPIFoundation/GlassButton', '3.3'
  s.dependency 'OPIFoundation/WebBrowser', '3.3'
  s.dependency 'OPIFoundation/CoreDataTools', '3.3'
  s.dependency 'OPIFoundation/UtilHelpers', '3.3'
