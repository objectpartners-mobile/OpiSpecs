Pod::Spec.new do |s|
  ...
  s.dependency 'OPIFoundation/IOSFrameworkCategories', '5.4'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '5.4'
  s.dependency 'OPIFoundation/UILayoutManagers', '5.4'
  s.dependency 'OPIFoundation/GlassButton', '5.4'
  s.dependency 'OPIFoundation/WebBrowser', '5.4'
  s.dependency 'OPIFoundation/CoreDataTools', '5.4'
  s.dependency 'OPIFoundation/UtilHelpers', '5.4'
