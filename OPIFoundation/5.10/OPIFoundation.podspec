Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/objectpartners-mobile/opiiosfoundation/tree/master"
  s.license      = {
    :type => 'OPI Proprietary',
    :text => <<-LICENSE
              Copyright (C) 2010-2015 Object Partners Inc.  All rights reserved.
    LICENSE
  }
  s.authors       = { "Steve McCoole" => "steve.mccoole@objectpartners.com", "Torey Lomenda" => "torey.lomenda@objectpartners.com" }
  s.source       = { :git => "https://github.com/objectpartners-mobile/opiiosfoundation.git", :tag => "5.10" }
  ...
  s.subspec 'UICustomViewsAndControllers' do |ss|
    ...
    ss.resources = 'UICustomViewsAndControllers/Resources/*'
    ss.requires_arc = true
