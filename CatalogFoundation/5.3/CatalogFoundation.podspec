Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/catalogiosfoundation.git", :tag => "5.3" }
  s.platform     = :ios, '6.0'
  ...
  s.dependency 'ContentSync', '~> 5.0'
  s.dependency 'OPIFoundation/UILayoutManagers', '~> 5.0'
  s.dependency 'OPIFoundation/UISketchPad', '~> 5.0'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '~> 5.0'
  #s.dependency 'OPIFoundation/UIThirdParty', '~> 5.0'
