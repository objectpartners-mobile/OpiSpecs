Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/catalogiosfoundation.git", :tag => "3.1" }
  s.platform     = :ios, '6.0'
  ...
  s.dependency 'ContentSync', '~> 3.0'
  s.dependency 'OPIFoundation/UILayoutManagers', '~> 4.0'
  s.dependency 'OPIFoundation/UISketchPad', '~> 4.0'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '~> 4.0'
  #s.dependency 'OPIFoundation/UIThirdParty', '~> 4.0'
