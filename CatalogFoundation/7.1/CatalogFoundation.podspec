Pod::Spec.new do |s|
  ...
  s.dependency 'ContentSync', '~> 7.1'
  s.dependency 'OPIFoundation/UILayoutManagers', '~> 7.1'
  s.dependency 'OPIFoundation/UISketchPad', '~> 7.1'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '~> 7.1'
