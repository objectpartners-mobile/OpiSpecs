Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/catalogiosfoundation.git", :tag => "4.2" }
  s.platform     = :ios, '6.0'
  ...
  s.dependency 'OPIFoundation/UISketchPad', '~> 4.1'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '~> 4.1'
  #s.dependency 'OPIFoundation/UIThirdParty', '~> 4.1'
