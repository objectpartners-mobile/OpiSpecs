Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/objectpartners-mobile/catalogiosfoundation.git", :tag => "1.1" }
  s.platform     = :ios, '5.0'
  ...
  s.dependency 'ContentSync', '1.1'
  s.dependency 'OPIFoundation/UILayoutManagers', '1.4.mod'
  s.dependency 'OPIFoundation/UISketchPad', '1.4.mod'
  s.dependency 'OPIFoundation/UICustomViewsAndControllers', '1.4.mod'
  s.dependency 'OPIFoundation/UIThirdParty', '1.4.mod'
