Pod::Spec.new do |s|
  ...
  s.subspec 'CatalogFoundation' do |ss|
    ss.source_files = 'ContentFoundation/**/*.{h,m,c}'
  	...
  	#-- In House (versioned)
  	#ss.dependency 'OPIFoundation/UILayoutManagers', '1.1.mod'
  	#ss.dependency 'OPIFoundation/UISketchPad', :'1.1.mod'
  	#ss.dependency 'OPIFoundation/UIThirdParty', '1.1.mod'
  	#ss.dependency 'OPIFoundation/UICustomViewsAndControllers', '1.1.mod'
  	#ss.dependency 'OPIFoundation/IOSFrameworkCategories', : '1.1.mod'
  end
  s.subspec 'ContentSyncCore' do |ss|
    ss.source_files = 'ContentSync/Core/**/*.{h,m,c}'
  	...
  	#-- In House (versioned) --
  	#ss.dependency 'OPIFoundation/UtilHelpers', '1.1.mod'
  	#ss.dependency 'OPIFoundation/UILayoutManagers', '1.1.mod'
  	#ss.dependency 'OPIFoundation/Reachability', '1.1.mod'
  	#ss.dependency 'OPIFoundation/IOSFrameworkCategories', '1.1.mod'
  	#ss.dependency 'OPIFoundation/ZipArchive', '1.1.mod'
  end
